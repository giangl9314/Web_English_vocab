...
function check_user_auth() {
    ...
    if (!check_session_timeout()) {
        ...
        header('Location: /WEB_ENGLISH_VOCAB/pages/dangnhap.html?timeout=1');
        exit();
    }
    ...
    if (!validate_session_security()) {
        ...
        header('Location: /WEB_ENGLISH_VOCAB/pages/dangnhap.html?error=security');
        exit();
    }
    ...
    if (!is_logged_in()) {
        ...
        header('Location: /WEB_ENGLISH_VOCAB/pages/dangnhap.html');
        exit();
    }
...
function check_admin_auth() {
    ...
    if (!is_admin()) {
        ...
        header('Location: /WEB_ENGLISH_VOCAB/pages/user/user_Dashboard.html');
        exit();
    }
}
?>
